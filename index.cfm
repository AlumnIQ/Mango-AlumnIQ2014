...
<mango:Posts count="2">
	<mango:Post>
		...
		<cfsavecontent variable="variables.nextLink"><mango:PostProperty link /></cfsavecontent>
	</mango:Post>
</mango:Posts>
		...
		<mango:Posts count="1">
			<mango:Post>
				<div class="post">
					...
					<mango:Event name="beforePostContentEnd" template="index" />

					<!--- if we're at the first post, the links will match, so don't display the previous button --->
					<cfif variables.nextLink neq variables.postLink>
						<mango:Archive pageSize="1">
							<div class="row margin-top-50">
								<div id="col-md-12">
									<mango:ArchiveProperty ifHasNextPage>
										<a class="btn btn-lg btn-danger pull-left" href="<cfoutput>#trim(variables.nextLink)#</cfoutput>"
